from sympy import symbols, expand, diff, integrate, simplify, nsimplify, collect, expand, Poly, Matrix, pprint
...
eigen_Matrix = Matrix([[0 for _ in range(len(poly_coeffs)-1)] for _ in range(len(poly_coeffs)-1)])
...
# eigen_value = eigen_Matrix.eigenvals()
